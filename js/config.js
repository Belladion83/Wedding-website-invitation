window.DEFAULT_WEDDING_CONFIG = {
  version: '1.57-dresscode-timeline-calendar-event-refine',
  ...
  images: {
    hero: 'assets/images/venue.jpg',
    envelope1: 'assets/images/venue.jpg',
    envelope2: 'assets/images/paper-invite.jpg',
  ...
  guests: [
    { id: 'A001', name: 'Quý khách', side: 'Khách chung' }
  ]
};
